...
const PostForm = ({ post, action }: PostFormProps) => {
  ...
  const form = useForm<z.infer<typeof PostValidation>>({
    ...
    defaultValues: {
      ...
      minSize:post?post.minSize.toString() :"1",
      maxSize:post?post.maxSize.toString():"1",
    },
  });
  ...
  async function onSubmit(values: z.infer<typeof PostValidation>) {
    ...
    formData.append("minSize", values.minSize); // Convert minSize to string
    ...
    <Form {...form}>
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col gap-9 w-full max-w-5xl ">
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel className="shad-form_label">Department</FormLabel>
              <FormControl>
                <Input type="text" className="shad-input" {...field} />
              </FormControl>
              <FormMessage className="shad-form_message" />
...
<FormField
  ...
  render={({ field }) => (
    <FormItem>
      <FormLabel className="shad-form_label">Amount per head</FormLabel>
      <FormControl>
        <Input
...
<FormField
  ...
  render={({ field }) => (
    <FormItem>
      <FormLabel className="shad-form_label">Team size minimum</FormLabel>
      <FormControl>
        <Input
          type="text"
          inputMode="numeric"  // Set inputMode to "numeric" to open the numeric keyboard on mobile devices
          pattern="[0-9]*"     // Use pattern attribute to allow only digits (integers)
          className="shad-input"
          {...field}
        />
      </FormControl>
...
<FormField
  ...
  render={({ field }) => (
    <FormItem>
      <FormLabel className="shad-form_label">Team size maximum </FormLabel>
      <FormControl>
        <Input
          type="text"
          inputMode="numeric"  // Set inputMode to "numeric" to open the numeric keyboard on mobile devices
